...
function About() {
  return (
    <Container>
      <Row>
        <Col sm>
          <Figure className="animate__animated animate__fadeIn mt-16 ml-24">
            <Figure.Image
              width={400}
              alt="CEO"
              src="./CEO.jpg"
        ...
        <Col sm>
          <section className="mt-28 ml-24 animate__animated animate__fadeInRight select-none">
            <h1 className="font-lexend text-xl text-whiteTxt underline underline-offset-8 mb-3"> o que é a dream nexus studios? : </h1>
            <p className="font-jura font-extralight text-whiteTxt text-xl">
      ...
      <Row>
        <Col sm>
          <section className="mt-28 ml-24 animate__animated animate__fadeInRight select-none mb-28">
            <h1 className="font-lexend text-xl text-whiteTxt"> criando mundos que você nunca vai</h1>
            <h1 className="font-lexend text-xl text-whiteTxt underline underline-offset-8 mb-3"> querer deixar :</h1>
            ...
            <p className="font-jura font-extralight text-whiteTxt text-xl mt-3">
        ...
        <Col sm>
          <Figure className="animate__animated animate__fadeInRight mt-16 ml-24">
            <Figure.Image
              width={400}
              alt="astralwield2"
              src="./game_5.jpg"
          ...
          <Figure className="animate__animated animate__fadeInRight ml-36">
            <Figure.Image
              width={400}
              alt="astralwield5"
              src="./game_4.jpg"
